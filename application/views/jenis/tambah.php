            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Tambah Jenis Barang</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li><i class="fi-server"></i>&nbsp; Master Data</li>
                                        <li><i class="fi-grid"></i>&nbsp; Jenis Barang</li>
                                        <li class="active"><i class="fa fa-wpforms"></i>&nbsp; Tambah Jenis Barang</li>
                                    </ol>
                        ...
                        <div class="card-box">
                            <?=form_open('jenis/tambah')?>
                                <div class="form-group">
                                    <label>KODE JENIS</label>
                                    <div>
                                        <input type="text" class="form-control" name="kodejenis" required autofocus 
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="namajenis" required autofocus 
