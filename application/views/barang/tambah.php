                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Tambah Barang / Produk</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li><i class="fi-archive"></i>&nbsp; Barang / Produk</li>
                                        <li class="active"><i class="fa fa-wpforms"></i>&nbsp; Tambah Barang / Produk</li>
                                    </ol>
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" name="kodebarang" value="<?=$kodeunik?>" required readonly 
                                        ...
                                        <div class="form-group">
                                            <label>BARCODE</label>
                                            <div>
                                                <input type="number" class="form-control" name="barcode" required autofocus 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="number" class="form-control" name="hargabarang" required autofocus data-parsley-type="number" data-parsley-minlength="1" data-parsley-maxlength="10" placeholder="Masukkan Harga Barang"/>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="heard" class="form-control" name="koderak" required autofocus>
                                                ...
                                                <?php foreach ($rak as $r):?>
                                                    <option value="<?=$r->koderak?>"><?=$r->namarak?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="number" class="form-control" name="jumlahbarang" required autofocus 
                                               data-parsley-type="number" data-parsley-minlength="1" data-parsley-maxlength="10" placeholder="Masukkan Stok Barang"/>
                                            </div>
                                        </div>
                                    </div>
