            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Tambah Satuan Barang</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li><i class="fi-server"></i>&nbsp; Master Data</li>
                                        <li><i class="fi-stack"></i>&nbsp; Satuan Barang</li>
                                        <li class="active"><i class="fa fa-wpforms"></i>&nbsp; Tambah Satuan Barang</li>
                                    </ol>
                        ...
                        <div class="card-box">
                            <?=form_open('satuan/tambah')?>
                                <div class="form-group">
                                    <label>KODE SATUAN</label>
                                    <div>
                                        <input type="text" class="form-control" name="kodesatuan" required autofocus 
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="namasatuan" required autofocus 
