            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Edit Pemasok Barang</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li><i class="dripicons-store"></i>&nbsp; Pemasok Barang</li>
                                        <li class="active"><i class="fa fa-wpforms"></i>&nbsp; Edit Pemasok Barang</li>
                                    </ol>
                        ...
                        <div class="card-box">
                            <?=form_open('pemasok/edit')?>
                            <?=form_hidden('kodepemasok', $pemasok['kodepemasok'])?>

                                <div class="form-group">
                                    <label>KODE PEMASOK</label>
                                    <div>
                                        <input type="text" class="form-control" name="kodepemasok" value="<?=$pemasok['kodepemasok']?>" required disabled 
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="namapemasok" value="<?=$pemasok['namapemasok']?>" required autofocus 
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="number" class="form-control" name="telp" value="<?=$pemasok['telp']?>" required autofocus 
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="email" class="form-control" name="email" value="<?=$pemasok['email']?>" required autofocus 
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input required class="form-control" name="alamat" value="<?=$pemasok['alamat']?>" required autofocus
                                        data-parsley-minlength="3" data-parsley-maxlength="50" placeholder="Masukkan Alamat Pemasok Barang"/>
                                    </div>
                                </div>
