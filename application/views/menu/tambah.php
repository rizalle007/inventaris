...
?>
                    ...
                    <div id="page-content">
                                ...
                                <div class="col-sm-6 hidden-xs">
                                    <div class="header-section">
                                        <ul class="breadcrumb breadcrumb-top">
                                            ...
                                            <li><a href="<?=base_URL()?>manajemenmenu/tambah">Tambah Menu</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="block full">
                            ...
                            <?=form_open('manajemenmenu/tambah', 'id="form-validation" role="form" class="form-horizontal form-bordered"')?>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="namamenu">Nama Menu <span class="text-danger">*</span></label>
                                    <div class="col-md-6">
                                        <input type="text" id="namamenu" name="namamenu" class="form-control" placeholder="Nama Menu" maxlength="50" autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="url" name="url" class="form-control" placeholder="URL Menu" maxlength="50" autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="icon" name="icon" class="form-control" placeholder="Icon Menu" maxlength="30" autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select id="submenu" name="submenu" class="form-control">
                                            ...
                                            <option value="0">Main Menu (Root)</option>
                                            <option value="" disabled>-------------------------------------</option>
                                            <?php foreach ($menu->result() as $m): ?>
                                                <option value="<?=$m->kodemenu?>"><?=$m->namamenu?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
