                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <h4 class="m-t-0 header-title">
                                         <?=anchor('transaksi_pembelian/tambah','<i class="mdi mdi-plus-circle-outline"></i> Tambah', 'class="btn btn-flat btn-info waves-effect waves-light"')?>
                                    </h4>
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="<?=base_url('transaksi_pembelian/detail')?>/<?=$p->nopembelian?>" data-toggle="tooltip" title="Detail Pembelian" class="btn btn-xs btn-primary waves-effect"><i class="fi-search"></i></a>
                                            </td>
                                            <td class="actions" align="center">
                                                <a href="<?=base_url('transaksi_pembelian/hapus')?>/<?=$p->nopembelian?>" onclick="return confirm('Kamu yakin mau menghapus data ini ?')" data-toggle="tooltip" title="Hapus Data" class="btn btn-effect-ripple btn-xs btn-danger"><i class="fa fa-times"></i></a>
                                            </td>
                                        </tr>
                                        <?php $no++; endforeach; ?>
                                        </tbody>
