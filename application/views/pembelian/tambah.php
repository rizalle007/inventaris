            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Tambah Transaksi Pembelian</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li><i class="fa fa-handshake-o"></i>&nbsp; Transaksi Pembelian</li>
                                        <li><i class="fa fa-wpforms"></i>&nbsp; Tambah Transaksi Pembelian</li>
                                        <li class="active"><i class="dripicons-store"></i>&nbsp; Pilih Pemasok Barang</li>
                                    </ol>
                        ...
                        <div class="card-box">
                            <form action="<?=base_URL()?>transaksi_pembelian/lanjut" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            <label>Pilih Pemasok Barang</label>
                                            <div class="row">
                                                <div class="col-xs-10">                             
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group m-b-0">
                                            <div>
                                                <?=anchor('transaksi_pembelian', '<i class="fa fa-arrow-circle-left"></i>&nbsp; Kembali', array('class' => 'btn btn-warning waves-effect m-l-5'))?>
                         ...
                         <table id="lookup" class="table table-hover table-striped table-bordered">
                            ...
                            <tbody>
                               ...
                               <?php foreach($pemasok as $p) { ?>
                                ...
                                <tr class="pilih" data-kodepemasok="<?=$p->kodepemasok?>">
