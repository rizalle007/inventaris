            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Edit rak Barang</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li><i class="fi-server"></i>&nbsp; Master Data</li>
                                        <li><i class="fi-columns"></i>&nbsp; Rak Barang</li>
                                        <li class="active"><i class="fa fa-wpforms"></i>&nbsp; Edit Rak Barang</li>
                                    </ol>
                        ...
                        <div class="card-box">
                            <?=form_open('rak/edit')?>
                            <?=form_hidden('koderak', $rak['koderak'])?>

                                <div class="form-group">
                                    <label>KODE RAK</label>
                                    <div>
                                        <input type="text" class="form-control" name="koderak" value="<?=$rak['koderak']?>" required disabled 
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="namarak" value="<?=$rak['namarak']?>" required autofocus 
